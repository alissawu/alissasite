    ...
    <>
      ...
      <main className={styles.postPage}>
        ...
        <article className={styles.postContent}>
          <h1>Manga Panels</h1>
          <p className={styles.date}>A collection of panels I like. Has spoiler protection.</p>
              ...
              panels={[
                ...
                },
                {
                  ...
                  description: `I like the intentional visual ambiguity/redaction. Too many manga do sex-appeal fanservice
                    ...
                    thoughts were emotionally raw. Seeing and wanting another person for everything they are.`
                }
              ]}
            />
