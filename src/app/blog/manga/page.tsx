        ...
        <article className={styles.postContent}>
          ...
          <section>
            <PanelCarousel
              title="Chainsaw Man"
              panels={[
                { src: "/blog/manga/chainsaw-man/ch1-denji.png", description: "From the start of CSM, Denji has gotten a lot of characterization by netizens for being joke-material horny. This is reflective of later messaging / character arcs as well, but I found it interesting that as he’s telling Pochita his dreams, the last one he voices out loud before going to sleep, is that he wants to hug a girl (contextually, one that loves him, but it’s not stated, because he doesn’t really know what he wants.) <- This is also implied when he talks about asking a girl to come over, going out on a date - Makima hugs him, she goes on a date with him, she brings him to her place – actualy, she fulfills all these wishes, and it’s through this empty fulfillment of his spoken wishes that he realizes it’s the underlying emotion that makes these things meaningful. I haven't decided how spoilery I'm making these captions so I'll leave it like this…"},
                { src: "/blog/manga/chainsaw-man/ch25-himeno.png", description: "This is such an important scene for building the world of CSM, contracts, and human relationships. We know contracts can be made with anything you have - skin, hair, lifespan, etc. But this is the first time such an intense contract is made. The resolve to give absolutely everything you have to save the one you love from death... I also thought it was cool because it contrasts with Makima. Himeno sacrifices her life, her everything to hold one attack the Gun agents had. Makima basically cripples the team all the way from Kyoto. And she knew their names too - how?"},
