          ...
          <section>
            <PanelCarousel
              ...
              panels={[
                ...
                { src: "/blog/manga/chainsaw-man/ch59-quanxi.jpeg", description: "I like her facial expression..."},
                ...
                { src: "/blog/manga/chainsaw-man/ch113-asa.jpg", description: "me"},
                { src: "/blog/manga/chainsaw-man/ch168-yoru.jpg", description: "Denji gets a lot of characterization as a joke-material horny MC, but he's actually pretty earnest. I felt really bad for him here. I don't necessarily think he's interpreting it as assault (technically it is). Like Denji is lowkey down if a girl is down. It's kinda bad. But like not that bad, because it's not the situation itself that's net negative, but rather that the girl ends up betraying him. But here it's specifically because this is an emotionally vulnerable moment where he makes a bid for a deeper emotional connection that gets completely rejected. And I'm pretty sure at this point he doesn't even know about the Yoru/Asa thing? He finds out about it like 30 chapters later I think, and the first thing he asks is which one of them jerked him off."},
            ...
            <PanelCarousel
              ...
              panels={[
                ...
                { src: "/blog/manga/horimiya/ch6-miya.jpeg", description: "I don't like the facial expressions that much in this panel. You can't take out the words and visualize the emotions, because it feels like, the emotions aren't drawn very indicatively. But the text is kind of heavy. It's spoken casually, but it's actually pretty important, because he's lightly conveying that he sees her in that way, but he's also very careful. There's just enough lightness to not leave pressure (this doesn't read as ambiguous but the prior context is needed)." },
                { src: "/blog/manga/horimiya/ch21-shindou.jpeg", description: "This felt like a conversation more people should read. Miyamura doesn't have this insight, because he's been a loner, but there are so many intentions you can have with someone - borderline ownership? being inseperable? showing them off? casual/noncasual intimacy? emotional closeness? - infinite, and no intentions are inherently wrong when accurately communicated and accepted, but the ultimate goal is to convey them and seek alignment. *I think the only bad intentions derive from deception."},
